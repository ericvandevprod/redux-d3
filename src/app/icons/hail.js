...
const hail = (props) => (
    <svg id="hail" width="200" height="200" style={{padding: '10px'}} viewBox="0 0 72 72" stroke="red" strokeWidth="1" {...props}>
      <g>
        ...
        <path d="M44,44c-1.1,0-2,0.9-2,2v16c0,0,0,0,0,0v0c0,0,0,0.1,0,0.1c0,0.1,0,0.2,0,0.3c0,0.1,0,0.1,0,0.2
		...
		c1.1,0.1,2.1-0.7,2.2-1.8c0.1-1.1-0.7-2.1-1.8-2.2c-3-0.2-5.8,0.6-8.1,2.3V46C46,44.9,45.1,44,44,44z"/>
        <path d="M38,52v-6c0-1.1-0.9-2-2-2s-2,0.9-2,2v6c0,1.1,0.9,2,2,2S38,53.1,38,52z"/>
        <path d="M30,56V46c0-1.1-0.9-2-2-2s-2,0.9-2,2v10c0,1.1,0.9,2,2,2S30,57.1,30,56z"/>
        <path d="M20,44c-1.1,0-2,0.9-2,2v10.4c-2.3-1.7-5.2-2.6-8.1-2.3c-1.1,0.1-1.9,1.1-1.8,2.2c0.1,1.1,1.1,1.9,2.2,1.8
		...
		c0-0.1,0-0.2,0-0.2c0,0,0-0.1,0-0.1v0c0,0,0,0,0,0V46C22,44.9,21.1,44,20,44z"/>
        <path d="M26.6,63.4C27,63.8,27.5,64,28,64c0.5,0,1.1-0.2,1.4-0.6C29.8,63,30,62.5,30,62c0-0.5-0.2-1-0.6-1.4
		c-0.7-0.7-2.1-0.7-2.8,0C26.2,61,26,61.5,26,62C26,62.5,26.2,63,26.6,63.4z"/>
        <path d="M34.6,59.4C35,59.8,35.5,60,36,60c0.5,0,1-0.2,1.4-0.6C37.8,59,38,58.5,38,58s-0.2-1-0.6-1.4
		c-0.7-0.7-2.1-0.7-2.8,0C34.2,57,34,57.5,34,58S34.2,59,34.6,59.4z"/>
        <path d="M61.4,57.4C61.8,57,62,56.5,62,56s-0.2-1-0.6-1.4c-0.8-0.8-2.1-0.8-2.8,0C58.2,55,58,55.5,58,56s0.2,1,0.6,1.4
		C59,57.8,59.5,58,60,58C60.5,58,61,57.8,61.4,57.4z"/>
      </g>
    </svg>
);
